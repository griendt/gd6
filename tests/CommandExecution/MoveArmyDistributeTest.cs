...
public class MoveArmyDistributeTest : BaseTest
{
    ...
    public void ItDistributesAnArmyInALongerPathInSteps()
    {
        var move = new MoveArmy
        {
            Issuer = Players.Player1,
            Origin = World.Territories[1],
            Path = [World.Territories[1], World.Territories[2], World.Territories[3]],
        };
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(World.Territories[3].Units.Armies, Is.EqualTo(1));
            ...
            Assert.That(World.Territories[2].Owner, Is.EqualTo(Players.Player1));
            Assert.That(World.Territories[3].Owner, Is.EqualTo(Players.Player1));
        });
    }
}