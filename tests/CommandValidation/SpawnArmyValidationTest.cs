...
public class SpawnArmyValidationTest : BaseTest
{
    ...
    [Test(Description = "The HQ was settled by the issuer, but another player is occupying it. The occupant may spawn.")]
    public void ItRejectsSpawningOnOwnHqIfNotOwned()
    {
        ...
        Assert.That(commands[0].Rejections[0].Reason, Is.EqualTo(RejectReason.SpawningOnInvalidTerritory));
    }
